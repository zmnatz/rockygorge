...
export const mdxComponents = {
  ...
  h4: (props) => (
    <Typography component="h4" variant="subtitle1" gutterBottom {...props} />
  ),
  h5: (props) => (
    <Typography component="h5" variant="subtitle2" gutterBottom {...props} />
  ),
  h6: (props) => (
    <Typography component="h6" variant="body1" gutterBottom {...props} />
  ),
  p: (props) => (
    <Typography
      component="p"
